...
" statements
syn region  puppetFunction      start="^\s*\(assert_type\|alert\|crit\|debug\|emerg\|err\|fail\|include\|contain\|info\|notice\|assert_type\|realize\|require\|search\|tag\|warning\)\s*(" end=")" contained contains=puppetString
" rvalues
...
syn keyword puppetKeyword       import inherits include require contain Optional String Integer Enum Array Hash Undef Float Numeric Boolean Regexp Sensitive Resource Class Default Scalar Collection Variant Data Pattern Enum Tuple Struct Optional Catalogentry Type Any Callable
